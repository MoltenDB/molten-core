...
import { createTestMoltenOptions, testCollection } from './helpers/collection';
describe('MoltenDB()', function () {
    it('should return a promise that rejects given invalid options', function () {
        ...
        promise.then(() => fail('Promise resolved instead of rejecting bad options'), () => Promise.resolve());
    });
...
describe('MoltenDB instance', function () {
    ...
    describe('createCollection()', () => {
        it('should return a Promise that rejects on bad options', () => {
            ...
            expect(promise).toEqual(jasmine.any(Promise));
            return promise.then(() => fail('createCollection promise resolved instead of rejecting'), () => Promise.resolve());
        });
    ...
    describe('', () => {
        ...
        describe('collection()', () => {
            it('should return a promise that rejects on an invalid collection name', (done) => {
        ...
        describe('checkCollection()', () => {
            it('should return a promise that rejects on bad collection options', () => {
                return this.mdb.checkCollection(false).then(() => fail('Promise should have rejected'), () => Promise.resolve());
            });
        ...
        describe('deleteCollection()', () => {
            it('should return an error that rejects on an invalid collection name', () => {
                return this.mdb.deleteCollection({}).then(() => fail('promise should have rejected'), () => Promise.resolve());
            });
