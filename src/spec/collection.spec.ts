    ...
    describe(description, () => {
      ...
      describe('create()', () => {
        it('should return a promise that rejects if given bad data', () => {
          return this.collection.create('bad').then(
              () => fail('create with bad data resolved'),
              () => Promise.resolve());
        });
      ...
      describe('read()', () => {
        ...
        it('should return a promise that rejects on an invalid query', () => {
          return this.collection.read('bad').then(
            () => fail('Promise should have rejected on bad query'),
            () => Promise.resolve());
        });
      ...
      describe('count()', () => {
        ...
        it('should return a promise that rejects on an invalid query', () => {
          return this.collection.count('bad').then(
              () => fail('Promise with query should have rejected'),
              () => Promise.resolve());
        });
